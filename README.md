...
|---|---|---|---|---|
| Sensing | **AI-G** | 카메라 → NPU 추론 → 차선 좌표 추출 | A53 Quad + NPU 8TOPS, MIPI CSI-2 | 정은진 |
...
```
LDAR-System/
├── ai-g/                              # Sensing Zone (정은진): 카메라·NPU 추론·후처리·TCP 송신
...
- 🟧 인지(AI-G) 추론 검증 · 제어 Phase 3(R5 하향 + VCP-G CAN 수신 통합)
- ⬜ Phase 4 통합·튜닝, 데모
